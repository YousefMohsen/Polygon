        ...
        <div id="container">
            <form action="FrontController?ID=rapportServlet" method="post">
                <div class="pages">
                    ...
                    <div id="addressform">
                        <div class="left">
                            <input type="text" name="nameOnBuilding" <% if (r != null) {%> value="<%= r.get(0).getBuildingName()%>" <% } else {
                                if (buildings != null) {%> value="<%= buildings.get(0).getBuildingName()%>" <% }
                                } %>>
                            <div class="border-bot"></div>
                            <p>Navn på bygning</p>
                            <input type="text" name="address" <% if (r != null) {%> value="<%= r.get(0).getAddress()%>" <% } else {
                                if (buildings != null) {%> value="<%= buildings.get(0).getAddress().getAddressline()%>" <% }
                                } %>> 
                            <div class="border-bot"></div>
                            <p>Adresse</p>
                            <input type="text" name="zipCity" <% if (r != null) {%> value="<%= r.get(0).getZip()%>" <% } else {
                                if (buildings != null) {%> value="<%= buildings.get(0).getAddress().getZipCode().getZip()%> / <%= buildings.get(0).getAddress().getZipCode().getCity()%>" <% }
                                } %>>
                            <div class="border-bot"></div>
                            <p>Postnr./By</p>
                        </div>
                    ...
                    <div id="examination-building-outside">
                        ...
                        <div>
                            <table cellspacing="0">
                                ...
                                <tr>
                                    <th><input type="radio" name="comments1" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentRoof() == 0) {%> checked <% }
                                        } %>></th>
                                    <th><input type="radio" name="comments1" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentRoof() == 1) {%> checked <% }
                                        } %>></th>
                                    <th><input type="checkbox" name="picture1" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureRoof() == 1) {%> checked <% }
                                        } %>></th>
                                </tr>
                                <tr>
                        ...
                        <div>
                            <table cellspacing="0">
                                ...
                                <tr>
                                    <th><input type="radio" name="comments2" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentOuterwall() == 0) {%> checked <% }
                                        } %>></th>
                                    <th><input type="radio" name="comments2" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentOuterwall() == 1) {%> checked <% }
                                        } %>></th>
                                    <th><input type="checkbox" name="picture2" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureOuterwall() == 1) {%> checked <% }
                                        } %>></th>
                                </tr>
                                <tr>
                ...
                <div class="pages">
                        ...
                        <div>
                            ...
                            <div id="room-info-checkbox">
                                <div class="border-left">
                                    <input type="radio" name="comment3" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentRoom() == 0) {%> checked <% }
                                        } %>>
                                    <p>Bemærkninger</p>
                                </div>
                                <div class="border-left">
                                    <input type="radio" name="comment3" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentRoom() == 1) {%> checked <% }
                                        } %>>
                    ...
                    <div id="damage-repair">
                        ...
                        <table cellspacing="0">
                            <tr>
                                ...
                                <th colspan="3">
                                    <div><input type="radio" name="yesNo1" value="0" <% if (r != null) {
                                            if (r.get(0).getYesNoRoomDamage() == 0) {%> checked <% }
                                        } %>> Ja</div>
                                    <div><input type="radio" name="yesNo1" value="1" <% if (r != null) {
                                            if (r.get(0).getYesNoRoomDamage() == 1) {%> checked <% }
                                        } %>> Nej</div>
                                </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Skade</th>
                                <th colspan="3">
                                    <div><input type="radio" name="damageRadio" value="1" <% if (r != null) {
                                            if (r.get(0).getDamageType() == 1) {%> checked <% }
                                        } %>> Fugt</div>
                                    <div><input type="radio" name="damageRadio" value="2" <% if (r != null) {
                                            if (r.get(0).getDamageType() == 2) {%> checked <% }
                                        } %>> Råd og swamp</div>
                                    <div><input type="radio" name="damageRadio" value="3" <% if (r != null) {
                                            if (r.get(0).getDamageType() == 3) {%> checked <% }
                                        } %>> Skimmel</div>
                                    <div><input type="radio" name="damageRadio" value="4" <% if (r != null) {
                                            if (r.get(0).getDamageType() == 4) {%> checked <% }
                                        } %>> Brand</div>
                                    <div>
                                        <input type="radio" name="damageRadio" value="5" <% if (r != null) {
                                                if (r.get(0).getDamageType() == 5) {%> checked <% }
                                            } %>> Anden skade 
                    ...
                    <div id="examination-of">
                        ...
                        <table cellspacing="0">
                            ...
                            <tr>
                                <th>Vægge</th>
                                <th><input type="radio" name="comments4" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentWall() == 0) {%> checked <% }
                                        } %>></th>
                                <th><input type="radio" name="comments4" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentWall() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureWall" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureWall() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Loft</th>
                                <th><input type="radio" name="comments5" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentCeiling() == 0) {%> checked <% }
                                        } %>></th>
                                <th><input type="radio" name="comments5" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentCeiling() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureCeiling" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureCeiling() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Gulv</th>
                                <th><input type="radio" name="comments6" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentFloor() == 0) {%> checked <% }
                                        } %>></th>
                                <th><input type="radio" name="comments6" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentFloor() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureFloor" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureFloor() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Vinduer/døre</th>
                                <th><input type="radio" name="comments7" value="0"> <% if (r != null) {
                                            if (r.get(0).getCommentWindows() == 0) {%> checked <% }
                                        } %></th>
                                <th><input type="radio" name="comments7" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentWindows() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureWindows" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureWindows() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th><input type="radio" name="comments8" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentOther() == 0) {%> checked <% }
                                        } %>></th>
                                <th><input type="radio" name="comments8" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentOther() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureOther" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureOther() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th><input type="radio" name="comments9" value="0" <% if (r != null) {
                                            if (r.get(0).getCommentOther2() == 0) {%> checked <% }
                                        } %>></th>
                                <th><input type="radio" name="comments9" value="1" <% if (r != null) {
                                            if (r.get(0).getCommentOther2() == 1) {%> checked <% }
                                        } %>></th>
                                <th><input type="checkbox" name="pictureOther2" value="1" <% if (r != null) {
                                            if (r.get(0).getPictureOther2() == 1) {%> checked <% }
                                        } %>></th>
                            </tr>
                            <tr>
                    ...
                    <div id="humidity-scan">
                        ...
                        <table cellspacing="0">
                            <tr>
                                ...
                                <th colspan="2">
                                    <div><input type="radio" name="yesNo2" value="0" <% if (r != null) {
                                            if (r.get(0).getHumidityYesNo() == 0) {%> checked <% }
                                        } %>> Ja</div>
                                    <div><input type="radio" name="yesNo2" value="1" <% if (r != null) {
                                            if (r.get(0).getHumidityYesNo() == 1) {%> checked <% }
                                        } %>> Nej</div>
                                </th>
                            </tr>
                            <tr>
                    ...
                    <div id="categorize">
                        ...
                        <table cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th><input type="radio" name="grade" value="1" <% if (r != null) {
                                        if (r.get(0).getCategorize() == 1) {%> checked <% }
                                    } %>></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="radio" name="grade" value="2" <% if (r != null) {
                                        if (r.get(0).getCategorize() == 2) {%> checked <% }
                                    } %>></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="radio" name="grade" value="3" <% if (r != null) {
                                        if (r.get(0).getCategorize() == 3) {%> checked <% }
                                    }%>></th>
                            </tr>
                        </table>
                    </div>
