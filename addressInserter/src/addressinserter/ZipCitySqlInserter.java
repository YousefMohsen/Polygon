 ...
 * @author joaci
 */
public class ZipCitySqlInserter {
   DB j = new DB();
    ...
    public void getDataFromSql()  {       
        ...
        try {          
            String sql;
            sql = "INSERT INTO Zipcode(zip,city) VALUES(?,?);";
            PreparedStatement pstmt = j.getConnection().prepareStatement(sql);
            
            for (int i = 0; i < ZIP_CITY.length; i = i+2) {
